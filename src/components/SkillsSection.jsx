...
const skills = [
    ...
    { name: "Pandas", level: 50, category: "data-science" },
    { name: "Matplotlib", level: 50, category: "data-science" },

    // Tools
    { name: "Git/GitHub", level: 50, category: "tools" },
    { name: "Figma", level: 40, category: "tools" },
    { name: "VS Code", level: 70, category: "tools" },
    { name: "Tableau", level: 40, category: "tools" },

];

const categories = ["all", "frontend", "programming", "tools", "data-science"];
